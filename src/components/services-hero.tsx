  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[680px] text-center">
        <p className="reveal-fade-up text-body-sm font-semibold tracking-[0.25em] uppercase text-teal-300" style={d(100)}>
          {hero.eyebrow}
        </p>
        <h1 className="reveal-fade-up mt-5 text-display-section text-text-on-dark" style={d(280)}>
          {hero.headline}
        </h1>
        <p className="reveal-fade-up mx-auto mt-6 max-w-[520px] text-body-lg text-text-on-dark-muted" style={d(450)}>
          {hero.description}
        </p>
      </div>
    </section>
